...
define("SUBJECT", "/^(?![\s])[\w,.!\-\s]{4,15}$/i"); // CERCEAS HANAPAN MO KO NG REGEX NA 4-15 characters yung range, pede numbers, tapos bawal special characters except ? ! _ -
/**
 ...
 */
define("BODY", "/^[\s\S\w\W]{1,280}$/"); // CERCEAS IKAW MAGISIP NG LIMITATION DITO BASTA MAY RANGE DAPAT TAPOS GAWAN MO NA DIN REGEX HEHEHEHE
